...
Tags: facebook, conversion, pixel, code, snippet
...
* [**Worth a 5-star review? Thank you!**](https://wordpress.org/support/plugin/fb-pixel-littlebizzy/reviews/?rate=5#new-post)
* [Plugin Homepage](https://www.littlebizzy.com/plugins/facebook-pixel)
* [Plugin GitHub](https://github.com/littlebizzy/facebook-pixel)
...
Saves the Facebook Pixel ID under `fbkpxl_settings` in options table, and deletes upon plugin uninstall.
...
1. First will load Google Analytics
2. Next will load Facebook Pixel
3. Last will load StatCounter
...
* [Facebook For WOoCommerce](https://github.com/facebookincubator/facebook-for-woocommerce/)
* [Facebook Conversion Pixel](https://wordpress.org/plugins/facebook-conversion-pixel/)

* [Pixel Your Site](https://wordpress.org/plugins/pixelyoursite/)
* [WP Facebook Pixel](https://wordpress.org/plugins/wp-facebook-pixel/)
...
1. Upload to `/wp-content/plugins/fb-pixel-littlebizzy`
